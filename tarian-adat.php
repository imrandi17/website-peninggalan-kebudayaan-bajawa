...
$view_tarian = mysqli_query($conn, "SELECT * FROM kebudayaan WHERE id_jenis_kebudayaan = 3");
      ...
      <div class="col-lg-12">
        <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
          <div class="section-title-area ltn__section-title-2">
            <h1 class="section-title white-color">Tarian Adat</h1>
          </div>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
          <div class="ltn__blog-item ltn__blog-item-3">
            <div class="ltn__blog-img">
              <a href="tarian-adat-detail?post=<?= $data['id_kebudayaan'] ?>"><img src="assets/img/kebudayaan/<?= $data['image_kebudayaan'] ?>" style="width: 100%; height: 300px; object-fit: cover;" alt="#"></a>
            </div>
            <div class="ltn__blog-brief">
              ...
              <h3 class="ltn__blog-title"><a href="tarian-adat-detail?post=<?= $data['id_kebudayaan'] ?>"><?= $data['nama_kebudayaan'] ?></a></h3>
              <div class="ltn__blog-meta-btn">
                ...
                <div class="ltn__blog-btn">
                  <a href="tarian-adat-detail?post=<?= $data['id_kebudayaan'] ?>">Lihat Lebih</a>
                </div>
              </div>
            </div>
          </div>
