...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['peninggalan_kebudayaan_bajawa']['name_page'])) {
                          if (!empty($_SESSION['peninggalan_kebudayaan_bajawa']['name_page'])) {
                            echo " - " . $_SESSION['peninggalan_kebudayaan_bajawa']['name_page'];
                          }
                        } ?>
</title>
