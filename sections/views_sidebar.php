...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="./">
  <div class="sidebar-brand-icon">
    <img src="<?= $baseURL ?>assets/img/logo-ngada.png" alt="Logo" style="width: 50px;">
  </div>
...
?>
  ...
  // print name page and title for comparison
  

  foreach ($subMenu as $sm) :

    if ($_SESSION['peninggalan_kebudayaan_bajawa']['name_page'] == $sm['title']) : ?>
      <li class="nav-item active">
      <?php else : ?>
      <li class="nav-item">
      <?php endif; ?>
