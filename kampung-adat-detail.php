        ...
        <div class="col-lg-12">
          <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
            <div class="section-title-area ltn__section-title-2">
              <h1 class="section-title white-color">Kampung Adat <?= $data['nama_kebudayaan'] ?></h1>
            </div>
            <div class="ltn__breadcrumb-list">
              <ul>
                <li><a href="./">Beranda</a></li>
                <li><a href="kampung-adat">Kampung Adat</a></li>
                <li>Kampung Adat <?= $data['nama_kebudayaan'] ?></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <aside class="sidebar-area blog-sidebar ltn__right-sidebar">
            ...
            <div class="widget ltn__popular-post-widget">
              <h4 class="ltn__widget-title ltn__widget-title-border">Kampung Adat Lainnya</h4>
              <ul>
                <?php
                $tarian_lain = "SELECT * FROM kebudayaan WHERE id_jenis_kebudayaan = 1 AND id_kebudayaan != '$data[id_kebudayaan]' ORDER BY id_kebudayaan DESC LIMIT 50";
                $view_tarian_lain = mysqli_query($conn, $tarian_lain);
                foreach ($view_tarian_lain as $item) { ?>
                  <li>
                    <div class="popular-post-widget-item clearfix">
                      <div class="popular-post-widget-img">
                        <a href="kampung-adat-detail?post=<?= $item['id_kebudayaan'] ?>"><img src="assets/img/kebudayaan/<?= $item['image_kebudayaan'] ?>" class="rounded-0" style="width: 60px; height: 60px; object-fit: cover;" alt="#"></a>
                      </div>
                      <div class="popular-post-widget-brief">
                        <h6><a href="kampung-adat-detail?post=<?= $item['id_kebudayaan'] ?>"><?= $item['nama_kebudayaan'] ?></a></h6>
                        <div class="ltn__blog-meta">
                          <ul>
                            <li class="ltn__blog-date">
