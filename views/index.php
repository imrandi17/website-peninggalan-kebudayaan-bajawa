...
$_SESSION["peninggalan_kebudayaan_bajawa"]["name_page"] = "";
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                Jenis Kebudayaan</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?= mysqli_num_rows($count_tempat_kebudayaan); ?></div>
            </div>
            <div class="col-auto">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="chart-area">
            <?php
            $currentYear = date("Y");
            $sql = "SELECT 'Tempat Wisata' as category, MONTH(created_at) as month, SUM(pembaca) as total 
              FROM tempat_kebudayaan 
