...
$_SESSION["peninggalan_kebudayaan_bajawa"]["name_page"] = "Galeri";
          ...
          <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <select name="id_tipe_fitur" id="id_tipe_fitur" class="form-select form-control" required>
                ...
                <option value="1">Jenis Kebudayaan</option>
                <option value="2">Tempat Kebudayaan</option>
              </select>
            </div>
          
            <div class="form-group" id="kebudayaan_form" style="display:none;">
              <label for="id_tempat_kebudayaan">Pilih Tempat Kebudayaan</label>
              <select name="id_tempat_kebudayaan" id="id_tempat_kebudayaan" class="form-select form-control" required>
                <?php foreach ($view_tempat_kebudayaan as $data_tw) : ?>
                  <option value="<?= $data_tw['id_tempat_kebudayaan'] ?>"><?= $data_tw['nama_kebudayaan'] ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-group">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const kebudayaanForm = document.getElementById('kebudayaan_form');

    function toggleForms() {
      const selectedValue = tipeFiturSelect.value;
      if (selectedValue == "1") {
        kulinerForm.style.display = 'block';
        kebudayaanForm.style.display = 'none';
      } else if (selectedValue == "2") {
        kulinerForm.style.display = 'none';
        kebudayaanForm.style.display = 'block';
      } else {
        kulinerForm.style.display = 'none';
        kebudayaanForm.style.display = 'none';
      }
